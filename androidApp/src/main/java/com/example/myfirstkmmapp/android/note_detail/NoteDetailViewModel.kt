...
class NoteDetailViewModel @Inject constructor(
    ...
    private val isNoteTitleHintVisible = savedStateHandle.getStateFlow("isNoteTitleFocussed", false)
    private val noteContent = savedStateHandle.getStateFlow("noteContent", "")
    private val isNoteContentHintVisible = savedStateHandle.getStateFlow("isNoteContentFocussed", false)
